...
public class JsonListMapTypeHandler extends BaseTypeHandler<List<Map<String, Object>>> {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, List<Map<String, Object>> value, JdbcType jdbcType) throws SQLException {
        try {
